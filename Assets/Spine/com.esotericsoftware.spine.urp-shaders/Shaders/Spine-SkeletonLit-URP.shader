Shader "Universal Render Pipeline/Spine/Skeleton Lit" {
	...
	SubShader {
		...
		Pass
		{
			...
			#define fixed3 half3
			#define fixed half
			#include "Assets/Spine/com.esotericsoftware.spine.urp-shaders/Shaders/Include/Spine-Input-URP.hlsl"
			#include "Assets/Spine/com.esotericsoftware.spine.urp-shaders/Shaders/Include/Spine-SkeletonLit-ShadowCasterPass-URP.hlsl"
