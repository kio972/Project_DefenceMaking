...
public class ResearchTreeLine : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        targetResearch._curState.Subscribe(_ => targetLine.gameObject.SetActive(_ == ResearchState.Complete)).AddTo(gameObject);
    }
}
